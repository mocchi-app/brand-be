...
data class BrandProduct(
    ...
    @Column("bp_title") val title: String?,
    @Column("bp_body_html") val bodyHtml: String?,
    @Column("bp_vendor") val vendor: String?,
    @Column("bp_product_type") val productType: String?,
    @Column("bp_created_at") val createdAt: OffsetDateTime?,
    @Column("bp_handle") val handle: String?,
    @Column("bp_updated_at") val updatedAt: OffsetDateTime?,
    @Column("bp_published_at") val publishedAt: OffsetDateTime?,
    @Column("bp_template_suffix") val templateSuffix: String?,
    @Column("bp_published_scope") val publishedScope: String?,
    @Column("bp_tags") val tags: String?,
